                                  ...
                                  children: [
                                    ...
                                    Text(whatIdoData[index]["title"],
                                      ...
                                      style: TextStyle(fontWeight: FontWeight
                                          .bold,
                                          fontSize: getCustomScreenType(context)==CustomScreenType.mobile?90.sp:30.sp, color: Colors
                                          .white),),
                                    SizedBox(height: 20.h,),
                                    Text(whatIdoData[index]["description"],
                                      ...
                                      style: TextStyle(fontSize: getCustomScreenType(context)==CustomScreenType.mobile?70.sp:20.sp,
                                          color: Colors.white),),
                                  ],
                                ),
                              ),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(projectsList[index]["title"],
                                              style: TextStyle(
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: getCustomScreenType(context)==CustomScreenType.mobile?90.sp:30.sp,
                                                  color: Colors.white),),
                                            Flexible(
                                              child: Text(
            ...
            child: StreamBuilder(
                ...
                return CarouselSlider(
                  items: List.generate(techStackData.length, (index)=>Image.network(
                    techStackData[index],
                      height: 200.w, fit: BoxFit.contain,)),
