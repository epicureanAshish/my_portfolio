...
class SkillsTabletView extends StatelessWidget {
  final List skills;
  const SkillsTabletView(this.skills, {super.key});
          ...
          children: [
            Row(
              children: [
                ...
                Text(
                    'Tech Stack',
                    style: AppTextStyles.sectionHeadingTextStyle(CustomScreenType.tablet)
                ),
              ],
            ),
