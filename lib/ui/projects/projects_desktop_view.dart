...
class ProjectsDesktopView extends StatelessWidget {
  ...
  const ProjectsDesktopView(this.projects, {super.key});
            ...
            children: [
              Row(
                children: [
                  ...
                  Text(
                    'Featured Projects',
                    style: AppTextStyles.sectionHeadingTextStyle(CustomScreenType.desktop)
                  ),
                ],
              ),
              // InkWell(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      ...
                                      style: AppTextStyles.projectTitleTextStyle(CustomScreenType.desktop)
                                    ),
                                  ),
                                  Container(
